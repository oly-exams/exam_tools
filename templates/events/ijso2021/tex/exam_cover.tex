...
\begin{letter}{\flushright{ \textbf{% templatetag openbrace %}{{ participant.code }} {{ exam.code }}{% if exam.flags|binand:exam.FLAG_SQUASHED %}{% else %}-{{ question.position }}{% endif %} C}\\{{ participant.full_name }}\\\textbf{\large {{ place }}} }}
\opening{}

\begin{center}
{\textbf{\Huge {{ exam.name }}\\ {% if exam.flags|binand:exam.FLAG_SQUASHED %}{% else %}{{ question.name }}{% endif %}}}
\vspace{1em}{% if exam.flags|binand:exam.FLAG_SQUASHED %}{% else %}\\{% endif %}
