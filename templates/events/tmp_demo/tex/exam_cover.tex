...
\begin{letter}{\flushright{ \textbf{% templatetag openbrace %}{{ participant.code }} {{ exam.code }}-{{ question.position }} C}\\{{ participant.first_name }} {{ participant.last_name }}\\\textbf{\large {{ place }}} }}
\opening{}
