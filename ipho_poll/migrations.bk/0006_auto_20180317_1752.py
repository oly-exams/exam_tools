...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='question',
            name='implementation',
            field=models.PositiveSmallIntegerField(default=0, choices=[(0, 'Not implemented'), (1, 'Implemented')]),
        ),
        migrations.AlterField(
            model_name='question',
            name='pub_date',
        ...
        migrations.AlterField(
            model_name='question',
            name='vote_result',
            field=models.PositiveSmallIntegerField(default=0, choices=[(0, 'In progress'), (1, 'Rejected'), (2, 'Accepted')]),
        ),
    ]
