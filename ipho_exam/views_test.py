...
def inline_edit(request):
    ...
    parts.append(u""" <p>1.1	Zwei gravitativ wechselwirkende Massen
    ...
    parts.append(u""" <p>1.2	Ein dritter Körper mit vernachlässigbarer
    ...
    parts.append(u""" <p>1.3	Betrachte den Fall $M=m$. Wenn die Masse
    ...
    parts.append(u""" <p> Die Laser-Interferometrie-Weltraumantenne
    ...
    parts.append(u""" <p>Die Sonden tauschen ständig Lasersignale
    ...
    parts.append(u""" <div class="figure"> <img src="{}" /><br /> ABBILDUNG 2: Bild der
    ...
    parts.append(u""" <div class="figure"> <img src="{}" /><br /> ABBILDUNG 3: Vergrösserte Sicht auf
