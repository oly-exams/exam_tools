        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (b"nynorsk", b"Nynorsk"),
                    (b"occitan", b"Occitan"),
                    (b"piedmontese", b"Piedmontese"),
                    (b"polish", b"Polish"),
                    (b"portuges", b"Portuges"),
                    (b"romanian", b"Romanian"),
                    (b"romansh", b"Romansh"),
                    (b"russian", b"Russian"),
                    (b"samin", b"Samin"),
                    (b"sanskrit", b"Sanskrit"),
                    (b"scottish", b"Scottish"),
                    (b"serbian", b"Serbian"),
                    (b"slovak", b"Slovak"),
                    ...
                    (b"turkish", b"Turkish"),
                    (b"turkmen", b"Turkmen"),
                    (b"ukrainian", b"Ukrainian"),
                    (b"urdu", b"Urdu"),
                    (b"usorbian", b"Usorbian"),
