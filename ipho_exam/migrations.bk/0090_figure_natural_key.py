...
def migrate_version_node(apps, qml_obj):
    if isinstance(qml_obj, QMLfigure):
        qml_obj.attributes["figid"] = get_updated_figid(
            apps, qml_obj.attributes["figid"]
        )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="figure",
            name="fig_id",
            field=models.URLField(max_length=100, db_index=True, blank=True),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.URLField(
                max_length=100, db_index=True, blank=False, unique=True
            ),
        ),
    ]
