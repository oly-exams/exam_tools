    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=100)),
                ('position', models.PositiveSmallIntegerField(help_text=b'Sortign index inside one exam')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=1, choices=[(b'P', b'proposal'), (b'C', b'confirmed')])),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(to='ipho_exam.Language')),
                ('question', models.ForeignKey(to='ipho_exam.Question')),
            ],
