...
urlpatterns = patterns('ipho_exam.views',
    ...
    url(r'^figure/(?P<fig_id>\d+)/(?P<lang_id>\d+)/export$', 'figure_export', {'output_format': 'svg'}, name='figure-lang-export'),

    url(r'^admin/?$', 'admin_list', name='admin'),
    url(r'^admin/(?P<exam_id>\d+)/quesiton/add$', 'admin_add_question', name='admin-add-question'),
    url(r'^admin/(?P<exam_id>\d+)/(?P<question_id>\d+)/question/delete$', 'admin_delete_question', name='admin-delete-question'),
    url(r'^admin/(?P<exam_id>\d+)/(?P<question_id>\d+)/question/edit$', 'admin_edit_question', name='admin-edit-question'),
    ...
    url(r'^admin/(?P<exam_id>\d+)/(?P<question_id>\d+)/v(?P<version_num>\d+)/settag$', 'admin_settag_version', name='admin-settag-version'),
