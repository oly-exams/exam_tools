...
urlpatterns = patterns('ipho_exam.views',
    ...
    url(r'^editor/(?P<exam_id>\d+)/question/(?P<question_id>\d+)/lang/(?P<lang_id>\d+)?$', 'editor', name='editor-lang'),
    url(r'^editor/(?P<exam_id>\d+)/question/(?P<question_id>\d+)/lang/(?P<lang_id>\d+)/(?P<orig_id>\d+)?$', 'editor', name='editor-orig'),
