...
urlpatterns = patterns(
    ...
    url(
        ...
        'admin_editor_move_block', {'direction': 'up'},
    ...
    url(
        ...
        'admin_editor_move_block', {'direction': 'down'},
