...
urlpatterns = [
    ...
    url(r'^view$', views.exam_view, name='exam-view'),
    ...
    url(r'^feedbacks/list/(?P<exam_id>\d+)/?$', views.feedbacks_list, name='feedbacks-list'),
    ...
    url(r'^feedbacks/numbers/(?P<exam_id>\d+)/(?P<question_id>\d+)$', views.feedback_numbers, name='feedback-numbers'),
    url(r'^feedbacks/partial/(?P<exam_id>\d+)/(?P<question_id>\d+)$', views.feedback_partial, name='feedback-partial'),
    url(r'^feedbacks/partial/(?P<exam_id>\d+)/(?P<question_id>\d+)/(?P<qml_id>[0-9a-z\-]+)$', views.feedback_partial, name='feedback-partial'),
    url(r'^feedbacks/(?P<status>(U|L))/(?P<feedback_id>\d+)$', views.feedback_partial_like, name='feedback-like'),
