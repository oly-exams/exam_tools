    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, help_text='Exam handouts', upload_to=ipho_exam.models.exam_prints_filename)),
                ...
                ('scan_file', models.FileField(blank=True, help_text='Scanned results. The file is show to the delegation and, if possible, it will contain only the pages with barcode.', upload_to=ipho_exam.models.exam_scans_filename)),
                ('scan_file_orig', models.FileField(blank=True, help_text='Original scanned document without page extractions', upload_to=ipho_exam.models.exam_scans_orig_filename)),
                ('scan_status', models.CharField(blank=True, choices=[('S', 'Success'), ('W', 'Warning'), ('M', 'Missing pages')], help_text='Status of the scanned document. S - Success, W - Warning, M - Missing pages', max_length=10, null=True)),
                ('scan_msg', models.TextField(blank=True, help_text='Warning messages generated by the barcode extractor', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='DocumentTask',
            fields=[
                ...
                ('document', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Document')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('T', 'Translation submission'), ('P', 'Points submission')], max_length=2)),
                ('status', models.CharField(choices=[('O', 'In progress'), ('S', 'Submitted')], default='O', max_length=1)),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('delegation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_status', to='ipho_core.Delegation')),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delegation_status', to='ipho_exam.Exam')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('status', models.CharField(choices=[('S', 'Submitted'), ('V', 'Scheduled for voting'), ('I', 'Implemented'), ('T', 'Settled'), ('R', 'Rejected')], default='S', max_length=1)),
                ('timestamp', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fig_id', models.URLField(db_index=True, default=ipho_exam.utils.natural_id.generate_id, max_length=100, unique=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('L', 'Liked'), ('U', 'Unliked')], max_length=1)),
                ('delegation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_core.Delegation')),
                ('feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Feedback')),
            ],
        ),
        migrations.CreateModel(
            name='PDFNode',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pdf', models.FileField(blank=True, upload_to=ipho_exam.models.get_file_path)),
                ('status', models.CharField(choices=[('O', 'In progress'), ('L', 'Locked'), ('S', 'Submitted')], default='O', max_length=1)),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Language')),
            ],
        ),
        migrations.CreateModel(
            name='Place',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_core.Student')),
            ],
        ),
        migrations.CreateModel(
            name='PrintLog',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('P', 'Printout'), ('S', 'Scan')], max_length=1)),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Document')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='e.g. Q for Question, A for Answer Sheet, G for General Instruction', max_length=8)),
                ('name', models.CharField(db_index=True, max_length=100)),
                ('position', models.PositiveSmallIntegerField(help_text='Sorting index inside one exam')),
                ('type', models.PositiveSmallIntegerField(choices=[(0, 'Question'), (1, 'Answer')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(blank=True, help_text='leave empty to show no tag', max_length=100, null=True)),
                ('status', models.CharField(choices=[('P', 'Proposal'), ('S', 'Staged'), ('C', 'Confirmed')], max_length=1)),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Language')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Question')),
            ],
        ...
        migrations.CreateModel(
            name='CompiledFigure',
            fields=[
                ('figure_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='ipho_exam.Figure')),
                ('content', models.TextField(blank=True)),
        ...
        migrations.AddField(
            model_name='pdfnode',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Question'),
        ),
        migrations.AddField(
            model_name='figure',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_ipho_exam.figure_set+', to='contenttypes.ContentType'),
        ),
        migrations.AddField(
            model_name='feedback',
            name='question',
        ...
        migrations.AddField(
            model_name='document',
            name='exam',
            field=models.ForeignKey(help_text='Exam', on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.Exam'),
        ),
        migrations.AddField(
            model_name='document',
            name='student',
            field=models.ForeignKey(help_text='Student', on_delete=django.db.models.deletion.CASCADE, to='ipho_core.Student'),
        ),
        migrations.AddField(
            model_name='attributechange',
            name='node',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ipho_exam.TranslationNode'),
        ),
